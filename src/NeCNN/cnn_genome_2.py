...
class CnnGenome2Config(DefaultGenomeConfig):
...
class CnnGenome2(object):
    ...
    def parse_config(cls, param_dict):
        ...
        return CnnGenome2Config(param_dict)
    ...
    def __init__(self, key):
        ...
        self.feature_extraction = DefaultGenome(1)
    ...
    def configure_new(self, config):
        ...
        self.feature_extraction.configure_new(config)

    def configure_crossover(self, genome1, genome2, config):
        self.classification.configure_crossover(genome1.classification, genome2.classification, config)
        self.feature_extraction.configure_crossover(genome1.feature_extraction, genome2.feature_extraction, config)

    def mutate(self, config):
        """ Mutates this genome. """
        self.classification.mutate(config)
        self.feature_extraction.mutate(config)
    ...
    def __str__(self):
        ...
        s += self.feature_extraction.__str__()
        return s

    def set_fitness(self, fitness):
        self.fitness = fitness
        self.classification.fitness = fitness
        self.feature_extraction.fitness = fitness
